    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          _buildStatRow('Posesión', '${stats.homePossession}%', '${stats.awayPossession}%'),
          _buildStatRow('Goles esperados', stats.homeExpectedGoals.toStringAsFixed(2), stats.awayExpectedGoals.toStringAsFixed(2)),
          _buildStatRow('Total Remates', '${stats.homeTotalShots}', '${stats.awayTotalShots}'),
          _buildStatRow('Remates al arco', '${stats.homeShotsOnTarget}', '${stats.awayShotsOnTarget}', 
            homeHighlight: stats.homeShotsOnTarget > stats.awayShotsOnTarget,
            awayHighlight: stats.awayShotsOnTarget > stats.homeShotsOnTarget),
          _buildStatRow('Grandes chances', '${stats.homeBigChances}', '${stats.awayBigChances}'),
          _buildStatRow('Saques de Esquina', '${stats.homeCorners}', '${stats.awayCorners}',
            homeHighlight: stats.homeCorners > stats.awayCorners,
            awayHighlight: stats.awayCorners > stats.homeCorners),
          _buildStatRow('Fueras de Juego', '${stats.homeOffsides}', '${stats.awayOffsides}'),
          _buildStatRow('Pases completados', '${stats.homeCompletedPasses}', '${stats.awayCompletedPasses}'),
          _buildStatRow('Tarjetas Rojas', '${stats.homeRedCards}', '${stats.awayRedCards}'),
          _buildStatRow('Ataques', '${stats.homeAttacks}', '${stats.awayAttacks}',
            homeHighlight: stats.homeAttacks > stats.awayAttacks,
            awayHighlight: stats.awayAttacks > stats.homeAttacks),
        ],
      ),
    );
  }
